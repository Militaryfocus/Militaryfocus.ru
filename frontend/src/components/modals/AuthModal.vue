<template>
  <TransitionRoot appear :show="authStore.showAuthModal" as="template">
    <Dialog as="div" @close="closeModal" class="relative z-50">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-dark-card p-6 text-left align-middle shadow-xl transition-all">
              ...
              <form v-else @submit.prevent="handleRegister" class="space-y-4">
                ...
                <div class="flex items-center">
                  ...
                  <label class="ml-2 text-sm text-gray-600 dark:text-gray-400">
                    Я согласен с 
                    <a href="/terms" target="_blank" class="text-primary-600 hover:text-primary-700">
              ...
              <div class="mt-6">
                <div class="relative">
                  ...
                  <div class="relative flex justify-center text-sm">
                    <span class="bg-white dark:bg-dark-card px-2 text-gray-500">Или войти через</span>
                  </div>
                </div>
